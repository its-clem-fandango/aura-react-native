...
const Create = () => {
  //get the user for submit function
  ...
  const openFilePicker = async (selectType) => {
    //use a modal to pick an image or video
  ...
  //TODO: work on upload functions to finish submit function
  const submit = async () => {
